  ...
  return (
    ...
    >
      ...
      >
        ...
        from-green-100 to-green-200 p-12 flex flex-col
        justify-center"
        >
          ...
          <p className="text-gray-600 mb-10">
            ...
            communication, technical knowledge and get instant feedback.
          </p>
            ...
            {[
              ...
              <motion.div
                ...
                className="flex items-center space-x-4
                   bg-white p-4 rounded-xl shadow-sm cursor-pointer hover:shadow-lg transition-shadow"
              >
