    ...
    return (
        ...
        border border-gray-200 py-8 px-3 text-center'>
                <div className='flex justify-center items-center gap-3 mb-3'>
                    ...
                    <h2 className='font-semibold'>AI Interview Platform</h2>
                </div>
                <p className='text-gray-500 text-sm max-w-xl mx-auto'>
                    AI-powered interview preparation platform designed to improve
                    communication skills, confidence, and interview performance
                    through realistic, technical depth and professional confidence.
                </p>
