                ...
                <div className='flex items-center gap-6 relative'>
                    <div className='relative'>
                        ...
                        {showCreditPopup && (
                            ...
                            p-5 z-50'>
                                <p className='text-sm text-gray-600 mb-4'>Need more credits to continue
                                    interviews?</p>
                                <button onClick={() => navigate("/pricing")}
                                    className='w-full bg-black text-white
                                py-2 rounded-lg cursor-pointer   hover:bg-gray-800
                                transition'>
                                    Get Credits
                                </button>
                    ...
                    <div className='relative'>
                        ...
                        {showUserPopup && (
                            <div className='text-center absolute right-0 mt-3 w-48 bg-white
                            shadow-xl border border-gray-200 riunded-xl p-2 
                            z-10'>
                                <p className=' text-md text-black-500 font-medium 
                                mb-1'>{userData?.name}</p>

                                <button onClick={() => navigate("/history ")} className='w-full text-left text-sm py-2
                                 text-black-600 transition cursor-pointer'>Interview History</button>
                                <button onClick={handleLogout}
                                    className='w-full text-left text-sm py-2
                                 text-red-600 flex items-center gap-2 transition cursor-pointer'>
