        ...
        items-center gap-10 mb-28'>
            {
              ...
              `}>
                  ...
                  <div className='absolute top-[-30px] left-[50%] translate-x-[-50%] bg-white 
                ...
                [
                  {
                    ...
                    desc: "Scores communication, clarity and confidence"
                  },
                  {
                    image: resumeImg,
                    ...
                    desc: "Detailed Strengths, Weaknesses & Improvement Areas."
                  }, {
                    image: analyticsImg,
                    icon: <BsBarChart size={20} />,
                    title: "Analytics & Performance Tracking",
                    desc: "Track improvement with performance graphs & detailed analytics."
                  }
                ].map((items, index) => (
                  <motion.div key={index}
                    initial={{ opacity: 0, y: 30 }}
                ...
                rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all'>
                  ...
                  gap-8'>
                     ...
                     rounded-xl flex items-center justify-center mb-6'>
                        ...
                        <h3 className='text-xl font-semibold mb-3'>{items.title}</h3>
                        <p className='text-gray-500 text-sm leading-relaxed'>{items.desc}</p>
            ...
            <div className='grid md:grid-cols-2 gap-10'>
              {
                [
                  ...
                  },
                  {
                    ...
                    desc: "Technical knowledge and problem-solving evaluation."
                  },
                  {
                    image: confidenceImg,
                    title: "Confidence detection",
                    desc: "Basic tone and voice modulation detection."
                  },
                  {
                    image: creditImg,
                    title: "Credit-Based Usage",
                    desc: "Unlock premium features with affordable credit packs."
                  }
                ].map((mode, index) => (
                  <motion.div key={index}
                    initial={{ opacity: 0, y: 30 }}
