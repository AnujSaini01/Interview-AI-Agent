...
function Pricing() {
  ...
  const plans = [
    {
      ...
      price: "$0",
      credits: 100,
      description: "Perfact for beginners starting interviews preparation.",
      features: [
  ...
  return (
    <div
      className="min-h-screen bg-linear-to-br from-gray-50 to-emerald-50
    py-16 px-6"
    >
        ...
        {plans.map((plan) => {
          ...
          return (
            ...
            >
              ...
              {plan.badge && (
                <div
                  className="absolute top-6 right-6 bg-emerald-600 text-white
